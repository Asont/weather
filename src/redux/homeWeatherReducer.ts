...
export type ActionTypeHome = HomeWeatherStateACType | HomeCityAndCountryACType

export const homeWeatherReducer = (state: StateType = initialState, action: ActionTypeHome) => {
    switch (action.type) {
        case 'SET_WEATHER': {
            return {
                ...state,
...
type HomeCityAndCountryACType = ReturnType<typeof CityAndCountryAC>
...
export const searchHomeWeatherTC = (city: string) => (dispatch: TypedDispatch) => {
